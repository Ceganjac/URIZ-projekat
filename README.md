...
2. Aktiviraj virtualno okruzenje: source .venv/Scripts/activate
3. Instaliraj dependencies: pip install -r requirements.txt
4. Popuni .env fajl: Treba popuniti OPENAI_API_KEY i LLM_MODEL.
